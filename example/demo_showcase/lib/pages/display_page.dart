        ...
        'child': {
          ...
          'children': [
            ...
            },
            {
              'type': 'text',
              'text': 'Bold heading',
              'style': {'fontSize': 24, 'fontWeight': 'bold', 'color': 'primary'},
            },
            ...
            _section('icon'),
            {
              ...
              'spacing': 16,
              'children': [
                {'type': 'icon', 'icon': 'home', 'size': 24, 'color': 'primary'},
                {'type': 'icon', 'icon': 'settings', 'size': 24, 'color': 'secondary'},
                {'type': 'icon', 'icon': 'favorite', 'size': 24, 'color': 'error'},
            ...
            _section('card'),
            {
              ...
              'child': {
                ...
                'child': {
                  ...
                  'spacing': 8,
                  'children': [
                    {'type': 'text', 'text': 'Card Title', 'style': {'fontSize': 18, 'fontWeight': 'bold'}},
                    {'type': 'text', 'text': 'Card content with description text.', 'style': {'fontSize': 14, 'color': 'onSurface'}},
                  ],
                },
              },
            },
            ...
            _section('avatar'),
            {
              ...
              'spacing': 12,
              'children': [
                {'type': 'avatar', 'label': 'AB', 'size': 40, 'backgroundColor': 'primary'},
                {'type': 'avatar', 'label': 'CD', 'size': 40, 'backgroundColor': 'secondary'},
            ...
            _section('decoration (box with gradient + shadow)'),
            {
              'type': 'box',
              'height': 80,
              'decoration': {
                ...
                'borderRadius': 12,
                'boxShadow': [
                  {'color': '#40000000', 'blurRadius': 8, 'offsetX': 0, 'offsetY': 4}
                ],
              },
              'child': {
                'type': 'center',
            ...
            _section('progressBar'),
            {
              ...
              'children': [
                ...
                {'type': 'text', 'text': '70%', 'style': {'fontSize': 12, 'color': 'onSurface'}},
              ],
            },
            ...
            _section('progressBar'),
            {
              ...
              'children': [
                {'type': 'progressBar'},
                {'type': 'text', 'text': 'Loading...', 'style': {'fontSize': 14}},
              ],
            },
