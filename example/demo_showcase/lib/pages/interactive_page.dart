          ...
          'children': [
            _section('gestureDetector'),
            {
              ...
              'child': {
                ...
                'child': {
                  ...
                  'child': {
                    'type': 'text',
                    'text': 'Tap / Double-tap / Long-press here',
                    'style': {'fontSize': 14},
                  },
                },
              },
            },
            {'type': 'text', 'text': 'Last gesture: {{lastGesture}}', 'style': {'fontSize': 12, 'color': 'onSurface'}},
            ...
            _section('inkWell'),
            {
              ...
              'child': {
                ...
                'child': {
                  'type': 'text',
                  'text': 'Tap me (with ripple) — tapped {{tapCount}} times',
                },
              },
            },
            ...
            {'type': 'text', 'text': 'Menu choice: {{menuChoice}}', 'style': {'fontSize': 12, 'color': 'onSurface'}},

            _section('image'),
            {
              'type': 'image',
              'src': 'https://placehold.co/200x100/2196F3/FFFFFF/png?text=Image+Demo',
              'width': 200,
              'height': 100,
              'fit': 'cover',
            },
              ...
              'children': [
                {
                  ...
                  'child': {
                    ...
                    'child': {
                      'type': 'center',
                      'child': {'type': 'text', 'text': 'Drag', 'style': {'color': '#FFFFFF'}},
                    },
                  },
                  'feedback': {
                    'type': 'box',
                    'width': 80,
                    'height': 80,
                    'decoration': {'color': '#64B5F6', 'borderRadius': 8},
                    'child': {
                      'type': 'center',
                      'child': {'type': 'text', 'text': '...', 'style': {'color': '#FFFFFF'}},
                    },
                  },
                },
                {
                  ...
                  'onDrop': {
                    ...
                    'binding': 'droppedItem', 'value': '{{event.data}}',
                  },
                  'builder': {
                    'type': 'conditional',
                    'condition': '{{dragData.hasCandidates}}',
                    'then': {
                      'type': 'box',
                      'width': 120,
                      'height': 80,
                    ...
                    'else': {
                      ...
                      'else': {
                        ...
                        'decoration': {
                          ...
                          'borderRadius': 8,
                          'border': {'color': 'outlineVariant', 'width': 2},
                        },
                        'child': {
                          'type': 'center',
                          'child': {'type': 'text', 'text': 'Drop here'},
                        },
                      },
                    },
                  },
            ...
            {'type': 'text', 'text': 'Dropped: {{droppedItem}}', 'style': {'fontSize': 12, 'color': 'onSurface'}},
            ...
            _section('rich text'),
            {
              ...
              'spans': [
                ...
                {'text': 'text ', 'style': {'color': 'primary'}},
                {'text': 'with ', 'style': {'fontStyle': 'italic'}},
                {'text': 'spans', 'style': {'color': 'secondary', 'fontWeight': 'bold'}},
              ],
            },
